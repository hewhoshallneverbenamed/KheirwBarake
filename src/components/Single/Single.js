...
import "./Single.css";
import Testprof from "../../assets/images/test.jpg";
              ...
              <div className="product-details">
                ...
                <div className="product-slider">
                  <div
                    ...
                    data-image="images/products/products-1.jpg"
                  >
                    <img
                  ...
                  <div
                    className="product-slider-item my-4"
                    data-image="images/products/products-2.jpg"
                  >
                    <img
                  ...
                  <div
                    className="product-slider-item my-4"
                    data-image="images/products/products-3.jpg"
                  >
                    <img
                      className="d-block img-fluid w-100"
                      src={Testprod}
                ...
                <div className="content mt-5 pt-5">
                  ...
                  <div className="tab-content" id="pills-tabContent">
                    ...
                    >
                      ...
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit. Quibusdam sed, officia reiciendis necessitatibus
                        obcaecati eum, quaerat unde illo suscipit placeat nihil
                        voluptatibus ipsa omnis repudiandae, excepturi! Id
                        aperiam eius perferendis cupiditate exercitationem,
                        mollitia numquam fuga, inventore quam eaque cumque
                        fugiat, neque repudiandae dolore qui itaque iste
                        asperiores ullam ut eum illum aliquam dignissimos
                        similique! Aperiam aut temporibus optio nulla numquam
                        molestias eum officia maiores aliquid laborum et
                        officiis pariatur, delectus sapiente molestiae sit
                        accusantium a libero, eligendi vero eius laboriosam
                        minus. Nemo quibusdam nesciunt doloribus repellendus
                        expedita necessitatibus velit vero?
                      </p>
                    </div>
                    <div
                          ...
                          <div className="media-body">
                            ...
                            <div className="review-comment">
                              <p>
                                ...
                                sit voluptatem accusantium doloremqe laudant
                                tota rem ape riamipsa eaque.
                              </p>
                            </div>
                          </div>
                        </div>
